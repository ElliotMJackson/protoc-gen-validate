...
public class EnumValidationTest {
    ...
    public void definedOnlyWorks() throws ValidationException {
        ...
        // Not Defined
        assertThatThrownBy(() -> EnumValidation.definedOnly("x", Enum.TestEnum.UNRECOGNIZED))
    ...
    public void inWorks() throws ValidationException {
        ...
        // Not In
        assertThatThrownBy(() -> CollectiveValidation.in("x", Enum.TestEnum.ONE, set))
                .isInstanceOf(ValidationException.class);
    }
    ...
    public void notInWorks() throws ValidationException {
        ...
        // In
        assertThatThrownBy(() -> CollectiveValidation.notIn("x", Enum.TestEnum.TWO, set))
                .isInstanceOf(ValidationException.class);
        // Not In
